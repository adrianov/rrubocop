//! RSpec/EmptyLineAfterExampleGroup — (breadth-first tree-sitter port).
...
const MSG: &str = "Add an empty line after `...`.";
...
impl Cop for EmptyLineAfterExampleGroup {
    ...
    fn check_node(
        ...
        const METHODS: &[&[u8]] = &[b"RSpec", b"end", b"else", b"elsif", b"rescue", b"ensure"];
