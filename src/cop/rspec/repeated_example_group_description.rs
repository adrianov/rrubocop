...
const MSG: &str = "RSpec/RepeatedExampleGroupDescription offense.";
...
impl Cop for RepeatedExampleGroupDescription {
    ...
    fn check_node(
        ...
        const METHODS: &[&[u8]] = &[b"skip", b"pending", b"shared_examples", b"shared_examples_for", b"shared_context", b"RSpec"];
