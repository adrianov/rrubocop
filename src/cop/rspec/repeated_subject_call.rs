//! RSpec/RepeatedSubjectCall — (breadth-first tree-sitter port).
...
const MSG: &str = "RSpec/RepeatedSubjectCall offense.";
...
impl Cop for RepeatedSubjectCall {
    ...
    fn check_node(
        ...
        const METHODS: &[&[u8]] = &[b"subject", b"RSpec", b"subject!", b"expect"];
