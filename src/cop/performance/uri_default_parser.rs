//! Performance/UriDefaultParser — (breadth-first tree-sitter port).
...
const MSG: &str = "Use `...URI::DEFAULT_PARSER` instead of `...URI::Parser.new`.";
...
impl Cop for UriDefaultParser {
    ...
    fn check_node(
        ...
        const METHODS: &[&[u8]] = &[b"new", b"Parser"];
